        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Proses Hash Based</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
...
if (isset($_POST['submit'])) {
    ...
    if (empty($_POST['min_support']) || empty($_POST['min_confidence'])) {
        ...
        ?>
        <script>
            location.replace("?menu=proses_hashbased&pesan_error=Min Support dan Min Confidence harus diisi");
        </script>
        <?php
    }
    if(!is_numeric($_POST['min_support']) || !is_numeric($_POST['min_confidence'])){
        ...
        ?>
        <script>
            location.replace("?menu=proses_hashbased&pesan_error=Min Support dan Min Confidence harus diisi angka");
        </script>
        <?php
    }
    ...
    if($can_process){
        ...
        if(isset($_POST['id_process'])){
            ...
            $query = $db_object->update_record("process_log_hashbased", $field, $where);
        }
        else{
            //insert log process
            $field_value = array(
            ...
            $query = $db_object->insert_record("process_log_hashbased", $field_value);
